...
In parallel to the development of the methdology, interviews were conducted with experts in the blockchain and sustainability space. The goal was to get feedback on the methodology and discuss relevant work that could inform the research.
...
- Alex de Vries, researcher and PHD candidate at VU asmterdam. He authored many of the influential papers in the space and collaborates regularly with the \ac{CCRI}. Expressed firm dissaproval of the hybrid attribution approach of the CCRI. His view was that attempts to weigh parameters were mostly driven by the industry pressure to average down per-transaction emission numbers.
